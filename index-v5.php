...
<body style="background-color: #faf8f8;">
    <div class="container" >
        <div>
            <h1 class="text-center">Recherche sur CV</h1>
            <form method="post" action="">
                ...
                <div>
                    <div class="row mt-3">
                        ...
                        <div class="col-md-3 d-flex align-items-end">
                            <input class="form-control" type="text" name="keywords" placeholder="Entrez des mots-clés" value="<?php echo $_POST["keywords"] ?? '' ?>">
                        </div>
                ...
                <div class="mt-3">
                    ...
                    <div id="selected-options1" class="selected-options">
                        <!-- Selected options will be displayed here -->
                    </div>
                    <div id="selected-options2" class="selected-options">
                        <!-- Selected options will be displayed here -->
                    </div>
                </div>
                <div class="col-md-2 mt-2">
